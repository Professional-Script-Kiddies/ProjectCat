...
BoardEdge.Transparency = 1
PointB.Transparency = 1
local real = game.Players.LocalPlayer.Character["Meshes/hvboardmeshAccessory"].Handle
...
function Attachments(P0,P1)
	...
	Attachment1.Orientation = Vector3.new(-90,0,80)
	end

real.AccessoryWeld:Destroy()

Attachments(real,Character.Hover.Part)
