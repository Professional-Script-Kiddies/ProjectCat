...
Attachment1.Orientation = Vector3.new(0,-93,0)
end


local Hat = workspace[game.Players.LocalPlayer.Name].R120Boar.Handle
Hat.AccessoryWeld:Destroy()
Attachments(Hat,tommygun)
...
mouse.Target.Parent:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
end
end)
end
end
