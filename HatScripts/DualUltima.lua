...
function Attachments(P0,P1,R,P)
...
Attachment1.Orientation = R or Vector3.new(0,0,0)
Attachment1.Position = P or Vector3.new(0,0,0)
...
local S1 = ccc["Cyberpunk Ninjatõ Blue (Back)"].Handle
local S2 = ccc["Cyperpunk Ninjatõ Blue"].Handle

S1.AccessoryWeld:Destroy()
S2.AccessoryWeld:Destroy()

Attachments(S1,handle,Vector3.new(10, 160, -140),Vector3.new(1, 1.5, 0))
Attachments(S2,handle2,Vector3.new(2.16894e-06, 90, 120),Vector3.new(0, 0.7, -1.8))
