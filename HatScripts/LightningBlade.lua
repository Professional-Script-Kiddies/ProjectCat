...
if _G.BotReanim == true then
    ...
    local askl = game.Players.LocalPlayer.Character
    local askl2 = askl:FindFirstChild("Meshes/dragonblade_meshAccessory").Handle
...
function AlignObject(Part0,Part1,Position,Rotate)
	...
	Attachment1.Position = Vector3.new(0,0,2.1)
	Attachment1.Orientation = Vector3.new(0,180,0)
end

local Hat = game.Players.LocalPlayer.Character["Meshes/dragonblade_meshAccessory"].Handle
if Hat:FindFirstChild("AccessoryWeld") then
	Hat.AccessoryWeld:Destroy()
end

AlignObject(Hat,handle)
