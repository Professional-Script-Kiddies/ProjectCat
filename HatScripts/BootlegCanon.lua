...
elseif Root.Velocity.Magnitude < 2 and dance == false and tripleshotsphase1 == false and tripleshotsphase2 == false and tripleshotsphase3 == true and tripleshotsphase4 == false then -- idle
    ...
    RH.C0 = RH.C0:Lerp(CF(.5+0*math.cos(sine/13),-0.6+0.04*math.cos(sine/13),-0.6+-0.1*math.cos(sine/13))*ANGLES(RAD(-5+0*math.cos(sine/13)),RAD(7+0*math.cos(sine/13)),RAD(-2+0*math.cos(sine/13))),.1)
    LH.C0 = LH.C0:Lerp(CF(-.5+0*math.cos(sine/13),-0.5+.1*math.cos(sine/13),-0.4+0*math.cos(sine/13))*ANGLES(RAD(-8+5*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.1)
    reanim['Angel wings'].Handle.AccessoryWeld.C0 = reanim['Angel wings'].Handle.AccessoryWeld.C0:Lerp(CF(0+0*math.cos(sine/13),-0.35+0*math.cos(sine/13),1.5+0*math.cos(sine/13))*ANGLES(RAD(-2+10*math.cos(sine/13)),RAD(180+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.1)
    reanim['Starslayer Railgun'].Handle.AccessoryWeld.C0 = reanim['Starslayer Railgun'].Handle.AccessoryWeld.C0:Lerp(CF(-1.2+0*math.cos(sine/13),0.2+0*math.cos(sine/13),-0+0*math.cos(sine/13))*ANGLES(RAD(-80+0*math.cos(sine/13)),RAD(-138+0*math.cos(sine/13)),RAD(-80+0*math.cos(sine/13))),.1)
...
elseif Root.Velocity.Magnitude < 2 and dance == true and attacking == false then -- idle
    reanim['Angel wings'].Handle.AccessoryWeld.C0 = reanim['Angel wings'].Handle.AccessoryWeld.C0:Lerp(CF(0+0*math.cos(sine/13),49+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.1)
    reanim['Starslayer Railgun'].Handle.AccessoryWeld.C0 = reanim['Starslayer Railgun'].Handle.AccessoryWeld.C0:Lerp(CF(-1.2+0*math.cos(sine/13),63+0*math.cos(sine/13),-0+0*math.cos(sine/13))*ANGLES(RAD(-80+0*math.cos(sine/13)),RAD(-138+0*math.cos(sine/13)),RAD(-80+0*math.cos(sine/13))),.1)
    NECK.C0 = NECK.C0:Lerp(CF(0+0*math.cos(sine/13),1+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.1)
