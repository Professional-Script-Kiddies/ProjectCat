...
local chara = Player.Character.Dummy
...
for _,v in pairs(chara.Rifle:GetChildren()) do
...
local pewpewalt = game.Players.LocalPlayer.Character["AR-L 10 SWAT [Front]"].Handle

pewpewalt.AccessoryWeld:Destroy()
...
Attachment1.Orientation = Vector3.new(0, 0, 15)
end

Attachments(pewpewalt,chara.Rifle.Handaru)
