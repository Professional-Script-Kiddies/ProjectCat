...
game:GetService("RunService").Heartbeat:Connect(function()
    bp.Position = char:FindFirstChild("Torso").Position
end)
...
local ccc = game.Players.LocalPlayer.Character


ccc["MeshPartAccessory"].Name = "Sword1"
ccc["MeshPartAccessory"].Name = "Sword2"
ccc["MeshPartAccessory"].Name = "Sword3"
ccc["MeshPartAccessory"].Name = "Sword4"
ccc["ShadowBladeMasterAccessory"].Name = "Sword5"
ccc["BladeMasterAccessory"].Name = "Sword6"

local S1 = ccc.Sword1.Handle
local S2 = ccc.Sword2.Handle
local S3 = ccc.Sword3.Handle
local S4 = ccc.Sword4.Handle
local S5 = ccc.Sword5.Handle
local S6 = ccc.Sword6.Handle
-- -gh 5972743380,5972741736,4506945409,4794315940,4458601937,4315489767



S1.AccessoryWeld:Destroy()
S2.AccessoryWeld:Destroy()
S3.AccessoryWeld:Destroy()
S4.AccessoryWeld:Destroy()
S5.AccessoryWeld:Destroy()
S6.AccessoryWeld:Destroy()
function Attachments(P0,P1,POS,ORI)
	...
	Attachment1.Position = POS or Vector3.new(0,-0.5,0)
	Attachment1.Orientation = ORI or Vector3.new(0, 0, 15)
end

Attachments(S1,lwing1,Vector3.new(0,0,0),Vector3.new(0,180,50))
Attachments(S2,lwing2,Vector3.new(0,0,0),Vector3.new(0,180,50))
Attachments(S3,rwing1,Vector3.new(0,0,0),Vector3.new(0,180,50))
Attachments(S4,rwing2,Vector3.new(0,0,0),Vector3.new(0,180,50))
Attachments(S5,lwing3,Vector3.new(0,0,0),Vector3.new(-0, -0, -50))
Attachments(S6,rwing3,Vector3.new(0,0,0),Vector3.new(-0, -0, -50))
