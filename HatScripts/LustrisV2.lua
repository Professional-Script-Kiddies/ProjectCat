...
local SHEZ = Instance.new("Sound",Character.HumanoidRootPart)SHEZ.SoundId = "rbxassetid://0" SHEZ.Looped = true SHEZ.Volume = 2 SHEZ:Play()
...
Attachment1.Orientation = Vector3.new(-0, 0, 140)
end


local Hat = workspace[game.Players.LocalPlayer.Name].MeshPartAccessory.Handle
